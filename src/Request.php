...
// use GuzzleHttp\Psr7\Utils::streamFor;
...
class Request
{
    ...
    protected function _addDefaultHeaders()
    {
        if ($this->_defaultHeaders) {
            ...
            $this->_headers['X-IG-App-Startup-Country'] = $this->_parent->getStartupCountry();
            $this->_headers['X-IG-Connection-Type']     = Constants::X_IG_Connection_Type;
            $this->_headers['X-IG-Connection-Speed']    = $this->_parent->emulateConnectionSpeed ? $this->_parent->getConnectionSpeed() : '-1kbps';
    ...
    protected function _getUrlencodedBody()
    {
        ...
        return \GuzzleHttp\Psr7\Utils::streamFor( // Throws.
