...
class Timeline extends RequestCollection
{
 ...
 public function getTimelineFeed(
    ...
    public function getUserGuides(
        ...
        $maxId = null)
    {
        $request = $this->ig->request("guides/user/{$userId}/")
            ->addParam('exclude_comment', true)
            ->addParam('only_fetch_first_carousel_media', false);
    ...
    public function getSelfUserGuides(
        $maxId = null)
    {
        return $this->getUserGuides($this->ig->account_id, $maxId);
    }
